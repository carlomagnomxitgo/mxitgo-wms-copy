    ...
    effects: {
        ...
        * login({ payload }, { call, put }) {
            ...
            if (response) {
                ...
                localStorage.setItem('sessionActive', localStorage.getItem('CognitoIdentityServiceProvider.66vntbnp4mpgn1o1p50pqd43kl.e1451cee-0f07-4784-8395-cc0ac548913f.accessToken'));
