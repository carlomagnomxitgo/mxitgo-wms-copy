                        ...
                        <Form {...formItemLayout} onSubmit={this.handleSubmit}>
                            <Row>
                                <Col lg={12} xl={24} className={Styles.avatar}>
                                    ...
                                    <div>
                                        <Upload changeImagen={this.handleChange} customRequest={this.dummyRequest} stateImage={(avatarUser ? avatarUser.urlImage : false)} stateName={"U"} />
                                ...
                                <Col lg={12} xl={12}>
                                    <Form.Item label={formatMessage({ id: 'register.label.lastfam' })}>
                                        {getFieldDecorator('family_name', {
                                            initialValue: userByEmail.family_name,
                                ...
                                <Col lg={12} xl={12}>
                                    <Form.Item label={formatMessage({ id: 'register.label.lastmid' })}>
                                        {getFieldDecorator('middle_name', {
                                            initialValue: userByEmail.middle_name,
                                ...
                                <Col lg={12} xl={12}>
                                    <Form.Item label={formatMessage({ id: 'register.label.email' })}>
                                        {getFieldDecorator('email', {
                                            initialValue: userByEmail.email,
